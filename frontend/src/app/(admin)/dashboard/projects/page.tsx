                                ...
                                projects
                                    ...
                                    .map((project) => (
                                        <tr key={project.id} className="group hover:bg-slate-50/50 transition-colors">
                                            ...
                                            <td className="px-4 py-5">
                                                <span className={`inline-flex items-center px-2.5 py-1 rounded-lg text-[10px] font-black uppercase tracking-widest ring-1 ring-inset ${project.status === 'COMPLETED' ? 'bg-emerald-50 text-emerald-600 ring-emerald-600/20' :
                                                    project.status === 'IN_PROGRESS' ? 'bg-amber-50 text-amber-600 ring-amber-600/20' :
